# Final update to include "Setup Costs" in cash outflow calculations with aging similar to "Monthly Expenses"
import os
import pandas as pd
...
for franchise_name in franchise_names:
    ...
    # Extract rows for setup costs, revenue, and monthly expenses
    setup_cost_row = franchise_df.iloc[0]  # "Setup Costs" row at index 0
    ...
    for index, row in control_df.iterrows():
        ...
        if period_label == "Starting":
            ...
            period_outflow = starting_franchises * (
                expense_row['Thereafter average'] + setup_cost_row['Thereafter average']
            )
        else:
            ...
            for i in range(len(monthly_franchise_ages)):
                ...
                if franchise_age <= 9:
                    ...
                    period_outflow += (expense_row['Thereafter average'] +
                                       setup_cost_row['Thereafter average'])
